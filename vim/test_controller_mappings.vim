...
" Tests Controller Web Index
nnoremap <silent> ,tcin :call IndentTemplate('test/controllers/actions/index_html.rb')<return>/DeleteThis\\|ChangePath\\|ChangeFactoryOptions\\|ChangeFactory\\|ChangeInstances\\|ChangeControllerInstance<return>
...
" Test Controllers Create Broadcast
nnoremap <silent> ,tccb :call IndentTemplate('test/controllers/actions/create_broadcast.rb')<return>/DeleteThis\\|ChangePath\\|ChangeFactoryOptions\\|ChangeFactory\\|ChangeModel\\|ChangeParam\\|ChangeValue\\|ChangeMethod\\|ChangeInstance<return>
