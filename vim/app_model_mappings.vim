...
nnoremap <silent> ,amba :call CreateBaseFile(1, 0, 1)<return>/class<return>wviwy/ChangeTopLevelDocumentation<return>viwpa model<esc><down>A < ApplicationRecord<esc>/inner_followup<return>cgn<esc>:call IndentTemplate('models/base.rb')<return>/DeleteThis\\|ChangeDefault\\|ChangeAttribute\\|ChangeTable<return>
" Associations
